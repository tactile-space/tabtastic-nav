      ...
      <div className="max-w-7xl mx-auto px-8 flex items-center justify-between w-full">
        ...
        <div className="flex items-center space-x-12">
          {links.map((link) => (
            ...
            >
              <span
                className={cn(
                  "text-sm font-medium transition-all duration-200 group-hover:text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-violet-600",
              ...
              <span
                className={cn(
                  "absolute bottom-5 left-0 w-full h-[2px] bg-gradient-to-r from-indigo-600 to-violet-600 transform origin-left transition-transform duration-300",
              ...
              <span
                className={cn(
                  "absolute inset-0 rounded-lg -z-10 transition-all duration-300 opacity-0 bg-gradient-to-r from-indigo-100/50 to-violet-100/50",
        ...
        <div className="flex-1 flex justify-end">
          <button className="relative px-6 py-3 rounded-full overflow-hidden group">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-indigo-600 to-violet-600 transition-all duration-200 group-hover:scale-[1.05]" />
            <div className="absolute inset-0 scale-x-0 group-hover:scale-x-100 transition-transform duration-500 bg-gradient-to-r from-violet-600 to-indigo-600" />
          </button>
        </div>
      </div>
    </nav>
